...
import com.kkh.statemanagementtest.ui.onboarding.HealthConcernChipItem
import com.kkh.statemanagementtest.ui.onboarding.HealthConcernUiModel
...
@Composable
fun DragDropList(
    items: List<HealthConcernUiModel>,
    onMove: (Int, Int) -> Unit,
    onNext: ()->Unit,
    onPrevious: ()->Unit,
